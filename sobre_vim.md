...
[Multiplos cursores](https://engagor.github.io/blog/2018/02/21/why-vim-doesnt-need-multiple-cursors/)  
...
- gU = maiúsculas
- g<TAB> = vai e volta da tab atual para a anterior
- gt = vai para próxima tab
- gT = vai para próxima tab
- tabmove +1 = move tab para a direita
- tabmove -1 = move tab para a esquerda
- cc = apaga a linha e entra no modo de inserção
- G = Vai para a última linha
- I = mostra os arquivos ocultos

- q = sai do arquivo
- q! = força a saida do arquivo
- mq = sai de todos os arquivos abertos

- gn = /palavra; pesquisa a correnpondência de termos (palavras) do último padrão usado, para frente
- gN = /palavra; pesquisa a correnpondência de termos (palavras) do último padrão usado, para trás
...
- sw = cria swafil (arquivo swap, de temporário, de transição)

- resize (- ou +) number = aumenta ou diminui o tamanho da aba (similar a CTRL + w + (- ou +))
- vertical-resize (- ou +) number = aumenta ou diminui o tamanho da aba (similar a CTRL + w + (< ou >))
...
- CTRL + x CTRL + n = (modo de inserção) autocompletar palavra para baixo
- CTRL + x CTRL + l || CTRL + x CTRL + p = (modo de inserção) autocompletar linha para cima
- CTRL + x CTRL + l = (modo de inserção) autocompletar linha para baixo
...
- CTRL + d => Alterar o tipo de search para nao considerar os nomes dos diretórios e somente o dos arquivos
